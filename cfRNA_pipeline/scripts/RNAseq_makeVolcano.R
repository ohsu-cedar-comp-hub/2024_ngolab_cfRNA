...
list_degFile = snakemake@input[['list_degFile']]

ERCC_degFile = snakemake@input[['ERCC_degFile']]
...
list_volcano_plot=snakemake@output[['list_volcano_plot']]

ERCC_volcano_plot=snakemake@output[['ERCC_volcano_plot']]
...
## check if an rda file or tab sep
deg <- read.delim(file=list_degFile)
...
## check if an rda file or tab sep
deg <- read.delim(file=ERCC_degFile)
