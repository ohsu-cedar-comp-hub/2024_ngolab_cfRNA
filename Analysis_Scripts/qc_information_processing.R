...
####Loading QC metadata
#publicly shared data is censored in multiple ways for patient privacy
#below data represents what was used to create some of the tables
#in this script (such as table 1) but will
#be unavailable to those using this repository.
...
qc_metrics_filtered <- qc_metrics_filtered 
...
ggsave("./Figures/supplemental3_figure_pdac.svg",
...
ggsave("./Figures/supplemental2_figure_pdac.svg",
